...
namespace UniversityCourseAndResultManagementSystem.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.DesignationId = new SelectList(db.Designations, "DesignationId", "DesignationInfo");
            return View();
        }
        ...
        public async Task<ActionResult> Create([Bind(Include = "TeacherId,TeacherName,Address,Email,ContactNo,DesignationId,DepartmentId,CreditToBeTaken")] Teacher teacher)
        {
